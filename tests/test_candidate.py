...
def payload():
    return dict(candidate_id="CRT-TEST-v0.1", evidence_refs=("source:1",),
        changed_rules=("rule:changed",), positive_fixture_refs=("fixture:pos",),
        negative_fixture_refs=("fixture:neg",), universe=("EUR_USD",), timeframes=("H1",),
        calendar="New York", timezone="UTC", data_provider="fixture", cost_model="fixed",
        dev_start="2020-01-01", dev_end="2020-12-31", oos_start="2021-01-01",
        oos_end="2021-12-31", confirm_start="2022-01-01", confirm_end="2022-12-31")
